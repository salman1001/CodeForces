...
public class DHanoiFactory {
    static Scanner sc=new Scanner(System.in);
    public static void main(String[] args) {
        int n= sc.nextInt();
        Tower[] towers=new Tower[n];
        for (int i=0;i<n;i++)  towers[i]=new Tower(sc.nextLong(), sc.nextLong(), sc.nextLong());
        Arrays.sort(towers);
    ...
    static class Tower implements Comparable<Tower>{
        long inner;long outer;long value;

        public Tower(long inner, long outer, long value) {
            this.inner = inner;
            this.outer = outer;
            this.value = value;
        }
        ...
        public int compareTo(Tower o) {
            if (outer==o.outer) return (int) (inner-o.inner);
            else return (int) (outer-o.outer);
        }
    }
