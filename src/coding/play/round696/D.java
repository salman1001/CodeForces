...
import coding.play.Day3.SegmentTree;
import coding.play.day4.PencilAndBoxes;
import coding.play.day4.SegmentTreeTemp;
...
public class D {
    ...
    static long[] b=new long[1000009];
    public static void main(String[] args) {
        ...
        for (int i=0;i<tc;i++){
            ...
            SegmentTree[] segmentTrees=new SegmentTree[2];
            segmentTrees[0]=new SegmentTree(b);
            segmentTrees[1]=new SegmentTree(b);
